...
<body bgcolor='#FFC300'>
	<div class='container mt-3'>
		...
		$select_query = "select * from home where id = $id";
		...
		<div style="font-size:20px;" align="center">
			<form 
			action='updatehome.php?id=<?php echo $row['id']?>&old_image=<?php echo $row['image'] ?>'
			method='post'
	...
	if(isset($_POST['updatebtn']))
	{
		...
		require '../dbcon.php';
		$update_query="update home set title='$title', description='$description', image='$image' where id=$id ";
