...
while($row=$data->fetch_assoc())
{
	...
	<tr>
		...
		<td><a href="deleteevent.php?id=<?php echo $row['id']?>" class="btn">remove</a>
			<a href="updateevent.php?id=<?php echo $row['id']?>&old_image=<?php echo $row['image']?>" class="btn">change</a>
		</td>
	</tr>
<?php } ?>
</table>
